<?php
/**
 * Class Max_Marine_Background_Processor_Abstract_REST_Controller
 */

namespace Max_Marine\Background_Processor\Core\Abstracts;

use WP_REST_Controller;
use Max_Marine\Background_Processor\Core\RestApi\Max_Marine_Background_Processor_REST_Authentication;

/**
 * Class Max_Marine_Background_Processor_Abstract_REST_Controller
 */
class Max_Marine_Background_Processor_Abstract_REST_Controller extends WP_REST_Controller {
	/**
	 ...
	 */
	public $namespace = 'max_marine/background_processor/v1';
	...
	public function check_admin_permission() {
		return Max_Marine_Background_Processor_REST_Authentication::check_admin_permission();
	}
	...
	public function check_user_permission() {
		return Max_Marine_Background_Processor_REST_Authentication::check_user_permission();
	}
}
