 ...
 * @author     David Baumwald <david@dream-encode.com>
 */
class Max_Marine_Background_Processor_List_Table extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'Thing', 'max-marine-background-processor' ),
				'plural'   => __( 'Things', 'max-marine-background-processor' ),
				'ajax'     => false,
			)
		);
	}
	...
	public function no_items() {
		esc_html_e( 'No things.', 'max-marine-background-processor' );
	}
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'timestamp':
				...
				if ( ! $date ) {
					$date = __( 'N/A', 'max-marine-background-processor' );
				}
	...
	public function get_columns() { // @phpcs:ignore
		$columns = array(
			'timestamp' => __( 'Date', 'max-marine-background-processor' ),
